...
const RegisterPage = () => {
  ...
  const register = async(e)=>{
    e.preventDefault();
    const reg = await axios.post("http://localhost:9002/register",user)
  ...
  return (
    ...
    <div className="Register-page font-[sans-serif] rounded-l-3xl border bg-gray-900 text-[#333] ml-52 mr-52 mt-12">
     <div className="grid  md:grid-cols-2 items-center gap-8 h-full">
       ...
       <form className="max-w-lg  w-full mx-auto" onSubmit={register}>
          <div className="mb-12">
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              <input name="name" value={user.name} type="text" required className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter username"onChange={handleChange} />
