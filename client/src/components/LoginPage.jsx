...
const LoginPage = () => {
    ...
    const login = async (e) => {
      ...
      try {
          const logi = await axios.post("http://localhost:9002/login", user);
        ...
        // i have use this.. so that input field will remains still till redirection
  ...
  return (
     ...
     <div className="grid md:grid-cols-2 items-center gap-8 h-full">
       ...
       <div className="flex items-center md:p-12 p-6 bg-white md:rounded-tl-[55px] md:rounded-bl-[55px] h-full">
         <form className="max-w-lg w-full mx-auto"onSubmit={login}>
           <div className="mb-12">
